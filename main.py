...
def extract_fecg(data):
    ...
    processing.plot_record(ica1, time_range=(0, 1))
    subtracted = analysis.ts_method(ica1, template_duration=0.12, fs=processing.FS)
    processing.plot_record(subtracted, time_range=(0, 1))
    # subtracted2 = analysis.ts_method(subtracted, template_duration=0.12, fs=processing.FS)
    # processing.plot_record(subtracted2, time_range=(0, 1))
